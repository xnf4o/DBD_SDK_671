...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NX03[0x3];                                   // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IR33[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_354W[0x10];                                  // 0x00C8(0x0010) MISSED OFFSET (PADDING)
