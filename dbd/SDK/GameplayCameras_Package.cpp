...
namespace CG
{
	...
	UClass* UTestCameraShake::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.TestCameraShake"));
		return ptr;
	}
	...
	UClass* USimpleCameraShakePattern::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.SimpleCameraShakePattern"));
		return ptr;
	}
	...
	UClass* UConstantCameraShakePattern::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.ConstantCameraShakePattern"));
		return ptr;
	}
	...
	UClass* UCompositeCameraShakePattern::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.CompositeCameraShakePattern"));
		return ptr;
	}
	...
	UClass* UDefaultCameraShakeBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.DefaultCameraShakeBase"));
		return ptr;
	}
	...
	class UMatineeCameraShake* UMatineeCameraShake::STATIC_StartMatineeCameraShakeFromSource(class APlayerCameraManager* PlayerCameraManager, class UClass* ShakeClass, class UCameraShakeSourceComponent* SourceComponent, float Scale, ECameraShakePlaySpace PlaySpace, const struct FRotator& UserPlaySpaceRot)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShake.StartMatineeCameraShakeFromSource"));
	...
	class UMatineeCameraShake* UMatineeCameraShake::STATIC_StartMatineeCameraShake(class APlayerCameraManager* PlayerCameraManager, class UClass* ShakeClass, float Scale, ECameraShakePlaySpace PlaySpace, const struct FRotator& UserPlaySpaceRot)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShake.StartMatineeCameraShake"));
	...
	void UMatineeCameraShake::ReceiveStopShake(bool bImmediately)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShake.ReceiveStopShake"));
	...
	void UMatineeCameraShake::ReceivePlayShake(float Scale)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShake.ReceivePlayShake"));
	...
	bool UMatineeCameraShake::ReceiveIsFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShake.ReceiveIsFinished"));
	...
	void UMatineeCameraShake::BlueprintUpdateCameraShake(float DeltaTime, float alpha, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShake.BlueprintUpdateCameraShake"));
	...
	UClass* UMatineeCameraShake::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.MatineeCameraShake"));
		return ptr;
	}
	...
	UClass* UMatineeCameraShakePattern::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.MatineeCameraShakePattern"));
		return ptr;
	}
	...
	UClass* UMovieSceneMatineeCameraShakeEvaluator::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.MovieSceneMatineeCameraShakeEvaluator"));
		return ptr;
	}
	...
	class UMatineeCameraShake* UMatineeCameraShakeFunctionLibrary::STATIC_Conv_MatineeCameraShake(class UCameraShakeBase* CameraShake)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function GameplayCameras.MatineeCameraShakeFunctionLibrary.Conv_MatineeCameraShake"));
	...
	UClass* UMatineeCameraShakeFunctionLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.MatineeCameraShakeFunctionLibrary"));
		return ptr;
	}
	...
	UClass* UPerlinNoiseCameraShakePattern::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.PerlinNoiseCameraShakePattern"));
		return ptr;
	}
	...
	UClass* UWaveOscillatorCameraShakePattern::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GameplayCameras.WaveOscillatorCameraShakePattern"));
		return ptr;
	}
