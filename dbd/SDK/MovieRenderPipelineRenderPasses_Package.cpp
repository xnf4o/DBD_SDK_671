...
namespace CG
{
	...
	UClass* UMoviePipelineImagePassBase::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineImagePassBase"));
		return ptr;
	}
	...
	UClass* UMoviePipelineDeferredPassBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineDeferredPassBase"));
		return ptr;
	}
	...
	UClass* UMoviePipelineDeferredPass_Unlit::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineDeferredPass_Unlit"));
		return ptr;
	}
	...
	UClass* UMoviePipelineDeferredPass_DetailLighting::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineDeferredPass_DetailLighting"));
		return ptr;
	}
	...
	UClass* UMoviePipelineDeferredPass_LightingOnly::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineDeferredPass_LightingOnly"));
		return ptr;
	}
	...
	UClass* UMoviePipelineDeferredPass_ReflectionsOnly::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineDeferredPass_ReflectionsOnly"));
		return ptr;
	}
	...
	UClass* UMoviePipelineDeferredPass_PathTracer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineDeferredPass_PathTracer"));
		return ptr;
	}
	...
	UClass* UMoviePipelineImageSequenceOutputBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineImageSequenceOutputBase"));
		return ptr;
	}
	...
	UClass* UMoviePipelineImageSequenceOutput_EXR::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineImageSequenceOutput_EXR"));
		return ptr;
	}
	...
	UClass* UMoviePipelineImageSequenceOutput_BMP::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineImageSequenceOutput_BMP"));
		return ptr;
	}
	...
	UClass* UMoviePipelineImageSequenceOutput_PNG::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineImageSequenceOutput_PNG"));
		return ptr;
	}
	...
	UClass* UMoviePipelineImageSequenceOutput_JPG::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineImageSequenceOutput_JPG"));
		return ptr;
	}
	...
	UClass* UMoviePipelineWaveOutput::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MovieRenderPipelineRenderPasses.MoviePipelineWaveOutput"));
		return ptr;
	}
