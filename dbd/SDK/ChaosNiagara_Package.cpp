...
namespace CG
{
	...
	UClass* UNiagaraDataInterfaceChaosDestruction::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ChaosNiagara.NiagaraDataInterfaceChaosDestruction"));
		return ptr;
	}
	...
	UClass* UNiagaraDataInterfacePhysicsField::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ChaosNiagara.NiagaraDataInterfacePhysicsField"));
		return ptr;
	}
