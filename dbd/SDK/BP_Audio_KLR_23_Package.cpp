...
namespace CG
{
	...
	void UBP_Audio_KLR_22_C::SelectAudioStatusStartEvent(bool IsInMenu, class UAkAudioEvent** AudioEvent)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_23.BP_Audio_KLR_22_C.SelectAudioStatusStartEvent"));
	...
	void UBP_Audio_KLR_22_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_23.BP_Audio_KLR_22_C.ReceiveBeginPlay"));
	...
	void UBP_Audio_KLR_22_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_23.BP_Audio_KLR_22_C.ReceiveEndPlay"));
	...
	void UBP_Audio_KLR_22_C::ExecuteUbergraph_BP_Audio_KLR_23(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_23.BP_Audio_KLR_22_C.ExecuteUbergraph_BP_Audio_KLR_23"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_Audio_KLR_22_C.StaticClass
	...
	UClass* UBP_Audio_KLR_22_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Audio_KLR_23.BP_Audio_KLR_22_C"));
		return ptr;
	}
