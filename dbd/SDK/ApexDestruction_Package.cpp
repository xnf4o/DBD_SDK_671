...
namespace CG
{
	...
	UClass* ADestructibleActor::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ApexDestruction.DestructibleActor"));
		return ptr;
	}
	...
	void UDestructibleComponent::SetDestructibleMesh(class UDestructibleMesh* NewMesh)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function ApexDestruction.DestructibleComponent.SetDestructibleMesh"));
	...
	class UDestructibleMesh* UDestructibleComponent::GetDestructibleMesh()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function ApexDestruction.DestructibleComponent.GetDestructibleMesh"));
	...
	void UDestructibleComponent::ApplyRadiusDamage(float BaseDamage, const struct FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function ApexDestruction.DestructibleComponent.ApplyRadiusDamage"));
	...
	void UDestructibleComponent::ApplyDamage(float DamageAmount, const struct FVector& HitLocation, const struct FVector& ImpulseDir, float ImpulseStrength)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function ApexDestruction.DestructibleComponent.ApplyDamage"));
	...
	UClass* UDestructibleComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ApexDestruction.DestructibleComponent"));
		return ptr;
	}
	...
	UClass* UDestructibleFractureSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ApexDestruction.DestructibleFractureSettings"));
		return ptr;
	}
	...
	UClass* UDestructibleMesh::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ApexDestruction.DestructibleMesh"));
		return ptr;
	}
