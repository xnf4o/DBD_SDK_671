...
namespace CG
{
	...
	TArray<class FName> UAssetTagsSubsystem::GetCollectionsContainingAssetPtr(class UObject* AssetPtr)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AssetTags.AssetTagsSubsystem.GetCollectionsContainingAssetPtr"));
	...
	TArray<class FName> UAssetTagsSubsystem::GetCollectionsContainingAssetData(const struct FAssetData& AssetData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AssetTags.AssetTagsSubsystem.GetCollectionsContainingAssetData"));
	...
	TArray<class FName> UAssetTagsSubsystem::GetCollectionsContainingAsset(const class FName& AssetPathName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AssetTags.AssetTagsSubsystem.GetCollectionsContainingAsset"));
	...
	TArray<class FName> UAssetTagsSubsystem::GetCollections()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AssetTags.AssetTagsSubsystem.GetCollections"));
	...
	TArray<struct FAssetData> UAssetTagsSubsystem::GetAssetsInCollection(const class FName& Name)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AssetTags.AssetTagsSubsystem.GetAssetsInCollection"));
	...
	bool UAssetTagsSubsystem::CollectionExists(const class FName& Name)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AssetTags.AssetTagsSubsystem.CollectionExists"));
	...
	UClass* UAssetTagsSubsystem::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AssetTags.AssetTagsSubsystem"));
		return ptr;
	}
