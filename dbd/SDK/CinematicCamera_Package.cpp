...
namespace CG
{
	...
	UClass* ACameraRig_Crane::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class CinematicCamera.CameraRig_Crane"));
		return ptr;
	}
	...
	class USplineComponent* ACameraRig_Rail::GetRailSplineComponent()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CameraRig_Rail.GetRailSplineComponent"));
	...
	UClass* ACameraRig_Rail::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class CinematicCamera.CameraRig_Rail"));
		return ptr;
	}
	...
	class UCineCameraComponent* ACineCameraActor::GetCineCameraComponent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraActor.GetCineCameraComponent"));
	...
	UClass* ACineCameraActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class CinematicCamera.CineCameraActor"));
		return ptr;
	}
	...
	void UCineCameraComponent::SetLensPresetByName(const class FString& InPresetName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.SetLensPresetByName"));
	...
	void UCineCameraComponent::SetFilmbackPresetByName(const class FString& InPresetName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.SetFilmbackPresetByName"));
	...
	void UCineCameraComponent::SetCurrentFocalLength(float InFocalLength)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.SetCurrentFocalLength"));
	...
	float UCineCameraComponent::GetVerticalFieldOfView()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetVerticalFieldOfView"));
	...
	TArray<struct FNamedLensPreset> UCineCameraComponent::STATIC_GetLensPresetsCopy()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetLensPresetsCopy"));
	...
	class FString UCineCameraComponent::GetLensPresetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetLensPresetName"));
	...
	float UCineCameraComponent::GetHorizontalFieldOfView()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetHorizontalFieldOfView"));
	...
	TArray<struct FNamedFilmbackPreset> UCineCameraComponent::STATIC_GetFilmbackPresetsCopy()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetFilmbackPresetsCopy"));
	...
	class FString UCineCameraComponent::GetFilmbackPresetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetFilmbackPresetName"));
	...
	class FString UCineCameraComponent::GetDefaultFilmbackPresetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function CinematicCamera.CineCameraComponent.GetDefaultFilmbackPresetName"));
	...
	UClass* UCineCameraComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class CinematicCamera.CineCameraComponent"));
		return ptr;
	}
