...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.IsCharacter
	 */
	struct UBP_Audio_KLR_25_C_IsCharacter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_TYJ4[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.SelectAudioStatusStartEvent
	 */
	struct UBP_Audio_KLR_25_C_SelectAudioStatusStartEvent_Params
	{
	public:
		bool                                                       IsInMenu;                                                // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_PP85[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.HitImpactOnSurvivorSFX
	 */
	struct UBP_Audio_KLR_25_C_HitImpactOnSurvivorSFX_Params
	{
	public:
	...
	/**
	 * Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.ExecuteUbergraph_BP_Audio_KLR_26
	 */
	struct UBP_Audio_KLR_25_C_ExecuteUbergraph_BP_Audio_KLR_26_Params
	{
	public:
