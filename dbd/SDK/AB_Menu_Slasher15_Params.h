...
namespace CG
{
	 ...
	 */
	struct UAB_Menu_Slasher15_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UAB_Menu_Slasher15_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UAB_Menu_Slasher15_C_ExecuteUbergraph_AB_Menu_Slasher15_Params
	{
	public:
