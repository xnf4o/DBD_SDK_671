...
namespace CG
{
	...
	UClass* UAudioAnalyzerAsset::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioAnalyzer.AudioAnalyzerAsset"));
		return ptr;
	}
	...
	UClass* UAudioAnalyzerNRTSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioAnalyzer.AudioAnalyzerNRTSettings"));
		return ptr;
	}
	...
	UClass* UAudioAnalyzerNRT::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioAnalyzer.AudioAnalyzerNRT"));
		return ptr;
	}
