...
namespace CG
{
	...
	void UAB_Menu_Slasher09_C::AnimGraph(struct FPoseLink* AnimGraph)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AB_Menu_Slasher09.AB_Menu_Slasher09_C.AnimGraph"));
	...
	void UAB_Menu_Slasher09_C::BlueprintUpdateAnimation(float DeltaTimeX)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AB_Menu_Slasher09.AB_Menu_Slasher09_C.BlueprintUpdateAnimation"));
	...
	void UAB_Menu_Slasher09_C::ExecuteUbergraph_AB_Menu_Slasher09(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AB_Menu_Slasher09.AB_Menu_Slasher09_C.ExecuteUbergraph_AB_Menu_Slasher09"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UAB_Menu_Slasher09_C.StaticClass
	...
	UClass* UAB_Menu_Slasher09_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("AnimBlueprintGeneratedClass AB_Menu_Slasher09.AB_Menu_Slasher09_C"));
		return ptr;
	}
