...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4OOK[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_QZTY[0x138];                                 // 0x0030(0x0138) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<class FName, struct FGameplayTagSource>               TagSources;                                              // 0x0168(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_ZGDT[0x80];                                  // 0x01B8(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_RA1C[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumBitsForContainerSize;                                 // 0x00A8(0x0004) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		int32_t                                                    NetIndexFirstBitSegment;                                 // 0x00AC(0x0004) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                              UnknownData_9H2P[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (PADDING)
