...
namespace CG
{
	...
	UClass* UActorSequence::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ActorSequence.ActorSequence"));
		return ptr;
	}
	...
	UClass* UActorSequenceComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ActorSequence.ActorSequenceComponent"));
		return ptr;
	}
	...
	UClass* UActorSequencePlayer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class ActorSequence.ActorSequencePlayer"));
		return ptr;
	}
