...
namespace CG
{
	...
	void ABP_Menu_CamperMale08_C::ExecuteUbergraph_BP_Menu_CamperMale08(int32_t EntryPoint)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Menu_CamperMale08.BP_Menu_CamperMale08_C.ExecuteUbergraph_BP_Menu_CamperMale08"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_Menu_CamperMale08_C.StaticClass
	...
	UClass* ABP_Menu_CamperMale08_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Menu_CamperMale08.BP_Menu_CamperMale08_C"));
		return ptr;
	}
