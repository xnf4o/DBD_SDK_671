...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_U87V[0xB0];                                  // 0x0000(0x00B0) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0SGI[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_DF1Z[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_75LA[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
