...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_H8YR[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_FXPJ[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	};
