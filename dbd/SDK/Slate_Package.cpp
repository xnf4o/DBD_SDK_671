...
namespace CG
{
	...
	UClass* UButtonWidgetStyle::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ButtonWidgetStyle"));
		return ptr;
	}
	...
	UClass* UCheckBoxWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.CheckBoxWidgetStyle"));
		return ptr;
	}
	...
	UClass* UComboBoxWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ComboBoxWidgetStyle"));
		return ptr;
	}
	...
	UClass* UComboButtonWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ComboButtonWidgetStyle"));
		return ptr;
	}
	...
	UClass* UEditableTextBoxWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.EditableTextBoxWidgetStyle"));
		return ptr;
	}
	...
	UClass* UEditableTextWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.EditableTextWidgetStyle"));
		return ptr;
	}
	...
	UClass* UProgressWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ProgressWidgetStyle"));
		return ptr;
	}
	...
	UClass* UScrollBarWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ScrollBarWidgetStyle"));
		return ptr;
	}
	...
	UClass* UScrollBoxWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ScrollBoxWidgetStyle"));
		return ptr;
	}
	...
	UClass* USlateSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.SlateSettings"));
		return ptr;
	}
	...
	UClass* USpinBoxWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.SpinBoxWidgetStyle"));
		return ptr;
	}
	...
	UClass* UTextBlockWidgetStyle::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.TextBlockWidgetStyle"));
		return ptr;
	}
	...
	UClass* UToolMenuBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Slate.ToolMenuBase"));
		return ptr;
	}
