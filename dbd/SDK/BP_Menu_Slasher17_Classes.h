...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_L0T1[0x4];                                   // 0x06EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UBP_Audio_KLR_17_C*                                  BP_Audio_KLR_18;                                         // 0x06F0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
