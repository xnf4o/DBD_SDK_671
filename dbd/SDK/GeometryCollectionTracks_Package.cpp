...
namespace CG
{
	...
	UClass* UMovieSceneGeometryCollectionSection::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GeometryCollectionTracks.MovieSceneGeometryCollectionSection"));
		return ptr;
	}
	...
	UClass* UMovieSceneGeometryCollectionTrack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GeometryCollectionTracks.MovieSceneGeometryCollectionTrack"));
		return ptr;
	}
