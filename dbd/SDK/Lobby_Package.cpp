...
namespace CG
{
	...
	void ALobbyBeaconClient::ServerSetPartyOwner(const struct FUniqueNetIdRepl& InUniqueId, const struct FUniqueNetIdRepl& InPartyOwnerId)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ServerSetPartyOwner"));
	...
	void ALobbyBeaconClient::ServerNotifyJoiningServer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ServerNotifyJoiningServer"));
	...
	void ALobbyBeaconClient::ServerLoginPlayer(const class FString& InSessionId, const struct FUniqueNetIdRepl& InUniqueId, const class FString& UrlString)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ServerLoginPlayer"));
	...
	void ALobbyBeaconClient::ServerKickPlayer(const struct FUniqueNetIdRepl& PlayerToKick, const class FText& Reason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ServerKickPlayer"));
	...
	void ALobbyBeaconClient::ServerDisconnectFromLobby()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ServerDisconnectFromLobby"));
	...
	void ALobbyBeaconClient::ServerCheat(const class FString& Msg)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ServerCheat"));
	...
	void ALobbyBeaconClient::ClientWasKicked(const class FText& KickReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientWasKicked"));
	...
	void ALobbyBeaconClient::ClientSetInviteFlags(const struct FJoinabilitySettings& Settings)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientSetInviteFlags"));
	...
	void ALobbyBeaconClient::ClientPlayerLeft(const struct FUniqueNetIdRepl& InUniqueId)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientPlayerLeft"));
	...
	void ALobbyBeaconClient::ClientPlayerJoined(const class FText& NewPlayerName, const struct FUniqueNetIdRepl& InUniqueId)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientPlayerJoined"));
	...
	void ALobbyBeaconClient::ClientLoginComplete(const struct FUniqueNetIdRepl& InUniqueId, bool bWasSuccessful)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientLoginComplete"));
	...
	void ALobbyBeaconClient::ClientJoinGame()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientJoinGame"));
	...
	void ALobbyBeaconClient::ClientAckJoiningServer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconClient.ClientAckJoiningServer"));
	...
	UClass* ALobbyBeaconClient::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Lobby.LobbyBeaconClient"));
		return ptr;
	}
	...
	UClass* ALobbyBeaconHost::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Lobby.LobbyBeaconHost"));
		return ptr;
	}
	...
	void ALobbyBeaconPlayerState::OnRep_UniqueId()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconPlayerState.OnRep_UniqueId"));
	...
	void ALobbyBeaconPlayerState::OnRep_PartyOwner()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconPlayerState.OnRep_PartyOwner"));
	...
	void ALobbyBeaconPlayerState::OnRep_InLobby()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconPlayerState.OnRep_InLobby"));
	...
	UClass* ALobbyBeaconPlayerState::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Lobby.LobbyBeaconPlayerState"));
		return ptr;
	}
	...
	void ALobbyBeaconState::OnRep_WaitForPlayersTimeRemaining()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconState.OnRep_WaitForPlayersTimeRemaining"));
	...
	void ALobbyBeaconState::OnRep_LobbyStarted()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function Lobby.LobbyBeaconState.OnRep_LobbyStarted"));
	...
	UClass* ALobbyBeaconState::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Lobby.LobbyBeaconState"));
		return ptr;
	}
