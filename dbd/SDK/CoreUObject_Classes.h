...
namespace CG
{
	...
	public:
		...
		unsigned char                                              pad_ZRLE7S388D[0x04];                                    // 0x0020(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_RRZV[0x48];                                  // 0x0030(0x0048) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FNLT[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8FAD[0x10];                                  // 0x00B8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QMX3[0x78];                                  // 0x0030(0x0078) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MJXG[0x188];                                 // 0x00B8(0x0188) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_WCFD6SZ1MS[0x01];                                    // 0x00BB(0x0001) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_A8N5WKW4KX[0x02];                                    // 0x00C2(0x0002) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_JP8TY5WEP8[0x04];                                    // 0x00D8(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_6DML[0x18];                                  // 0x00E8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B91H[0x80];                                  // 0x0240(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QEW2[0xB8];                                  // 0x0030(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UWKG[0x30];                                  // 0x0038(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_J3EW[0x1B8];                                 // 0x0240(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_X4NL[0xC8];                                  // 0x0030(0x00C8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_N975[0x1B8];                                 // 0x00E8(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WIUV[0xA0];                                  // 0x0030(0x00A0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6ERO[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IY42[0x48];                                  // 0x0038(0x0048) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P56U[0x10];                                  // 0x0080(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SSJX[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PKNQ[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7H4D[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_D1JL[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RHT2[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I82S[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EZD3[0x28];                                  // 0x0080(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OIDH[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CLKC[0x20];                                  // 0x0080(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2ZPV[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FNE6[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EPVT[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (PADDING)
