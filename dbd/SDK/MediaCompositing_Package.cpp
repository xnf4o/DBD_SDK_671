...
namespace CG
{
	...
	UClass* UMovieSceneMediaPlayerPropertySection::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MediaCompositing.MovieSceneMediaPlayerPropertySection"));
		return ptr;
	}
	...
	UClass* UMovieSceneMediaPlayerPropertyTrack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MediaCompositing.MovieSceneMediaPlayerPropertyTrack"));
		return ptr;
	}
	...
	UClass* UMovieSceneMediaSection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MediaCompositing.MovieSceneMediaSection"));
		return ptr;
	}
	...
	UClass* UMovieSceneMediaTrack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class MediaCompositing.MovieSceneMediaTrack"));
		return ptr;
	}
