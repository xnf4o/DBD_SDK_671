...
namespace CG
{
	...
	UClass* USoundfieldEncodingSettingsBase::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.SoundfieldEncodingSettingsBase"));
		return ptr;
	}
	...
	UClass* UAudioEndpointSettingsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.AudioEndpointSettingsBase"));
		return ptr;
	}
	...
	UClass* UDummyEndpointSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.DummyEndpointSettings"));
		return ptr;
	}
	...
	UClass* USpatializationPluginSourceSettingsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.SpatializationPluginSourceSettingsBase"));
		return ptr;
	}
	...
	UClass* UOcclusionPluginSourceSettingsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.OcclusionPluginSourceSettingsBase"));
		return ptr;
	}
	...
	UClass* UReverbPluginSourceSettingsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.ReverbPluginSourceSettingsBase"));
		return ptr;
	}
	...
	UClass* USoundModulatorBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.SoundModulatorBase"));
		return ptr;
	}
	...
	UClass* USoundfieldEndpointSettingsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.SoundfieldEndpointSettingsBase"));
		return ptr;
	}
	...
	UClass* USoundfieldEffectSettingsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.SoundfieldEffectSettingsBase"));
		return ptr;
	}
	...
	UClass* USoundfieldEffectBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioExtensions.SoundfieldEffectBase"));
		return ptr;
	}
