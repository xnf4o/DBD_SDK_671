...
namespace CG
{
	...
	void UAudioCapture::StopCapturingAudio()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AudioCapture.AudioCapture.StopCapturingAudio"));
	...
	void UAudioCapture::StartCapturingAudio()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AudioCapture.AudioCapture.StartCapturingAudio"));
	...
	bool UAudioCapture::IsCapturingAudio()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AudioCapture.AudioCapture.IsCapturingAudio"));
	...
	bool UAudioCapture::GetAudioCaptureDeviceInfo(struct FAudioCaptureDeviceInfo* OutInfo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AudioCapture.AudioCapture.GetAudioCaptureDeviceInfo"));
	...
	UClass* UAudioCapture::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioCapture.AudioCapture"));
		return ptr;
	}
	...
	class UAudioCapture* UAudioCaptureFunctionLibrary::STATIC_CreateAudioCapture()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AudioCapture.AudioCaptureFunctionLibrary.CreateAudioCapture"));
	...
	UClass* UAudioCaptureFunctionLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioCapture.AudioCaptureFunctionLibrary"));
		return ptr;
	}
	...
	UClass* UAudioCaptureComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AudioCapture.AudioCaptureComponent"));
		return ptr;
	}
