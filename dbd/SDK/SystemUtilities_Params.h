...
namespace CG
{
	 ...
	 */
	struct UBoolExt_ToString_Params
	{
	public:
		...
		unsigned char                                              UnknownData_RMAB[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UPlatformUtilities_GetPlatform_Params
	{
	public:
