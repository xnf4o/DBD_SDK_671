...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_M1C6[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ECTH[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1AXI[0x7];                                   // 0x0069(0x0007) MISSED OFFSET (PADDING)
