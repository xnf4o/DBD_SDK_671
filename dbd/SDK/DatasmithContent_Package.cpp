...
namespace CG
{
	...
	UClass* UDatasmithObjectTemplate::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithObjectTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithActorTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithActorTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithAdditionalData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithAdditionalData"));
		return ptr;
	}
	...
	UClass* ADatasmithAreaLightActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithAreaLightActor"));
		return ptr;
	}
	...
	UClass* UDatasmithAreaLightActorTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithAreaLightActorTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithAssetImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithAssetImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithStaticMeshImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshCADImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithStaticMeshCADImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithTranslatedSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithTranslatedSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithCADImportSceneData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithCADImportSceneData"));
		return ptr;
	}
	...
	UClass* UDatasmithMDLSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithMDLSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithGLTFSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithGLTFSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshGLTFImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithStaticMeshGLTFImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithFBXSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithFBXSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithDeltaGenAssetImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithDeltaGenAssetImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithDeltaGenSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithDeltaGenSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithVREDAssetImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithVREDAssetImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithVREDSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithVREDSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithIFCSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithIFCSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshIFCImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithStaticMeshIFCImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithAssetUserData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithAssetUserData"));
		return ptr;
	}
	...
	UClass* UDatasmithCineCameraActorTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithCineCameraActorTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithCineCameraComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithCineCameraComponentTemplate"));
		return ptr;
	}
	...
	class FString UDatasmithContentBlueprintLibrary::STATIC_GetDatasmithUserDataValueForKey(class UObject* Object, const class FName& Key)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey"));
	...
	void UDatasmithContentBlueprintLibrary::STATIC_GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, const class FString& StringToMatch, TArray<class FName>* OutKeys, TArray<class FString>* OutValues)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue"));
	...
	class UDatasmithAssetUserData* UDatasmithContentBlueprintLibrary::STATIC_GetDatasmithUserData(class UObject* Object)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData"));
	...
	UClass* UDatasmithContentBlueprintLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithContentBlueprintLibrary"));
		return ptr;
	}
	...
	UClass* UDatasmithCustomActionBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithCustomActionBase"));
		return ptr;
	}
	...
	UClass* UDatasmithDecalComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithDecalComponentTemplate"));
		return ptr;
	}
	...
	void ADatasmithImportedSequencesActor::PlayLevelSequence(class ULevelSequence* SequenceToPlay)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence"));
	...
	UClass* ADatasmithImportedSequencesActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithImportedSequencesActor"));
		return ptr;
	}
	...
	UClass* UDatasmithOptionsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithOptionsBase"));
		return ptr;
	}
	...
	UClass* UDatasmithCommonTessellationOptions::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithCommonTessellationOptions"));
		return ptr;
	}
	...
	UClass* UDatasmithImportOptions::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithImportOptions"));
		return ptr;
	}
	...
	UClass* UDatasmithLandscapeTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithLandscapeTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithLightComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithLightComponentTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithMaterialInstanceTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithMaterialInstanceTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithPointLightComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithPointLightComponentTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithPostProcessVolumeTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithPostProcessVolumeTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithScene::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithScene"));
		return ptr;
	}
	...
	UClass* ADatasmithSceneActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithSceneActor"));
		return ptr;
	}
	...
	UClass* UDatasmithSceneComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithSceneComponentTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithSkyLightComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithSkyLightComponentTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithSpotLightComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithSpotLightComponentTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithStaticMeshComponentTemplate"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class DatasmithContent.DatasmithStaticMeshTemplate"));
		return ptr;
	}
