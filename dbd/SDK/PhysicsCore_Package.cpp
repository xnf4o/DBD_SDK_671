...
namespace CG
{
	...
	UClass* UBodySetupCore::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PhysicsCore.BodySetupCore"));
		return ptr;
	}
	...
	UClass* UChaosPhysicalMaterial::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PhysicsCore.ChaosPhysicalMaterial"));
		return ptr;
	}
	...
	UClass* UPhysicalMaterial::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PhysicsCore.PhysicalMaterial"));
		return ptr;
	}
	...
	UClass* UPhysicalMaterialPropertyBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PhysicsCore.PhysicalMaterialPropertyBase"));
		return ptr;
	}
	...
	UClass* UPhysicsSettingsCore::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PhysicsCore.PhysicsSettingsCore"));
		return ptr;
	}
