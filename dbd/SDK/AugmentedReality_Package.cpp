...
namespace CG
{
	...
	class UARComponent* AARActor::AddARComponent(class UClass* InComponentClass, const struct FGuid& NativeID)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARActor.AddARComponent"));
	...
	UClass* AARActor::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARActor"));
		return ptr;
	}
	...
	void UARBlueprintLibrary::STATIC_UnpinComponent(class USceneComponent* ComponentToUnpin)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.UnpinComponent"));
	...
	bool UARBlueprintLibrary::STATIC_ToggleARCapture(bool bOnOff, EARCaptureType CaptureType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.ToggleARCapture"));
	...
	void UARBlueprintLibrary::STATIC_StopARSession()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.StopARSession"));
	...
	void UARBlueprintLibrary::STATIC_StartARSession(class UARSessionConfig* SessionConfig)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.StartARSession"));
	...
	void UARBlueprintLibrary::STATIC_SetEnabledXRCamera(bool bOnOff)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.SetEnabledXRCamera"));
	...
	void UARBlueprintLibrary::STATIC_SetARWorldScale(float InWorldScale)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.SetARWorldScale"));
	...
	void UARBlueprintLibrary::STATIC_SetARWorldOriginLocationAndRotation(const struct FVector& OriginLocation, const struct FRotator& OriginRotation, bool bIsTransformInWorldSpace, bool bMaintainUpDirection)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.SetARWorldOriginLocationAndRotation"));
	...
	void UARBlueprintLibrary::STATIC_SetAlignmentTransform(const struct FTransform& InAlignmentTransform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.SetAlignmentTransform"));
	...
	bool UARBlueprintLibrary::STATIC_SaveARPinToLocalStore(const class FName& InSaveName, class UARPin* InPin)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.SaveARPinToLocalStore"));
	...
	struct FIntPoint UARBlueprintLibrary::STATIC_ResizeXRCamera(const struct FIntPoint& InSize)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.ResizeXRCamera"));
	...
	void UARBlueprintLibrary::STATIC_RemovePin(class UARPin* PinToRemove)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.RemovePin"));
	...
	void UARBlueprintLibrary::STATIC_RemoveARPinFromLocalStore(const class FName& InSaveName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.RemoveARPinFromLocalStore"));
	...
	void UARBlueprintLibrary::STATIC_RemoveAllARPinsFromLocalStore()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.RemoveAllARPinsFromLocalStore"));
	...
	class UARPin* UARBlueprintLibrary::STATIC_PinComponentToTraceResult(class USceneComponent* ComponentToPin, const struct FARTraceResult& TraceResult, const class FName& DebugName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.PinComponentToTraceResult"));
	...
	bool UARBlueprintLibrary::STATIC_PinComponentToARPin(class USceneComponent* ComponentToPin, class UARPin* Pin)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.PinComponentToARPin"));
	...
	class UARPin* UARBlueprintLibrary::STATIC_PinComponent(class USceneComponent* ComponentToPin, const struct FTransform& PinToWorldTransform, class UARTrackedGeometry* TrackedGeometry, const class FName& DebugName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.PinComponent"));
	...
	void UARBlueprintLibrary::STATIC_PauseARSession()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.PauseARSession"));
	...
	TMap<class FName, class UARPin*> UARBlueprintLibrary::STATIC_LoadARPinsFromLocalStore()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.LoadARPinsFromLocalStore"));
	...
	TArray<struct FARTraceResult> UARBlueprintLibrary::STATIC_LineTraceTrackedObjects3D(const struct FVector& Start, const struct FVector& End, bool bTestFeaturePoints, bool bTestGroundPlane, bool bTestPlaneExtents, bool bTestPlaneBoundaryPolygon)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.LineTraceTrackedObjects3D"));
	...
	TArray<struct FARTraceResult> UARBlueprintLibrary::STATIC_LineTraceTrackedObjects(const struct FVector2D& ScreenCoord, bool bTestFeaturePoints, bool bTestGroundPlane, bool bTestPlaneExtents, bool bTestPlaneBoundaryPolygon)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.LineTraceTrackedObjects"));
	...
	bool UARBlueprintLibrary::STATIC_IsSessionTypeSupported(EARSessionType SessionType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.IsSessionTypeSupported"));
	...
	bool UARBlueprintLibrary::STATIC_IsSessionTrackingFeatureSupported(EARSessionType SessionType, EARSessionTrackingFeature SessionTrackingFeature)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.IsSessionTrackingFeatureSupported"));
	...
	bool UARBlueprintLibrary::STATIC_IsSceneReconstructionSupported(EARSessionType SessionType, EARSceneReconstruction SceneReconstructionMethod)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.IsSceneReconstructionSupported"));
	...
	bool UARBlueprintLibrary::STATIC_IsARSupported()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.IsARSupported"));
	...
	bool UARBlueprintLibrary::STATIC_IsARPinLocalStoreSupported()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.IsARPinLocalStoreSupported"));
	...
	bool UARBlueprintLibrary::STATIC_IsARPinLocalStoreReady()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.IsARPinLocalStoreReady"));
	...
	EARWorldMappingState UARBlueprintLibrary::STATIC_GetWorldMappingStatus()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetWorldMappingStatus"));
	...
	EARTrackingQualityReason UARBlueprintLibrary::STATIC_GetTrackingQualityReason()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetTrackingQualityReason"));
	...
	EARTrackingQuality UARBlueprintLibrary::STATIC_GetTrackingQuality()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetTrackingQuality"));
	...
	TArray<struct FARVideoFormat> UARBlueprintLibrary::STATIC_GetSupportedVideoFormats(EARSessionType SessionType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetSupportedVideoFormats"));
	...
	class UARSessionConfig* UARBlueprintLibrary::STATIC_GetSessionConfig()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetSessionConfig"));
	...
	TArray<struct FVector> UARBlueprintLibrary::STATIC_GetPointCloud()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetPointCloud"));
	...
	class UARTexture* UARBlueprintLibrary::STATIC_GetPersonSegmentationImage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetPersonSegmentationImage"));
	...
	class UARTexture* UARBlueprintLibrary::STATIC_GetPersonSegmentationDepthImage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetPersonSegmentationDepthImage"));
	...
	bool UARBlueprintLibrary::STATIC_GetObjectClassificationAtLocation(const struct FVector& InWorldLocation, EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetObjectClassificationAtLocation"));
	...
	int32_t UARBlueprintLibrary::STATIC_GetNumberOfTrackedFacesSupported()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetNumberOfTrackedFacesSupported"));
	...
	class UARLightEstimate* UARBlueprintLibrary::STATIC_GetCurrentLightEstimate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetCurrentLightEstimate"));
	...
	bool UARBlueprintLibrary::STATIC_GetCameraIntrinsics(struct FARCameraIntrinsics* OutCameraIntrinsics)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetCameraIntrinsics"));
	...
	class UARTextureCameraImage* UARBlueprintLibrary::STATIC_GetCameraImage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetCameraImage"));
	...
	class UARTextureCameraDepth* UARBlueprintLibrary::STATIC_GetCameraDepth()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetCameraDepth"));
	...
	float UARBlueprintLibrary::STATIC_GetARWorldScale()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetARWorldScale"));
	...
	class UARTexture* UARBlueprintLibrary::STATIC_GetARTexture(EARTextureType TextureType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetARTexture"));
	...
	struct FARSessionStatus UARBlueprintLibrary::STATIC_GetARSessionStatus()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetARSessionStatus"));
	...
	TArray<class UARTrackedPose*> UARBlueprintLibrary::STATIC_GetAllTrackedPoses()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllTrackedPoses"));
	...
	TArray<class UARTrackedPoint*> UARBlueprintLibrary::STATIC_GetAllTrackedPoints()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllTrackedPoints"));
	...
	TArray<class UARPlaneGeometry*> UARBlueprintLibrary::STATIC_GetAllTrackedPlanes()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllTrackedPlanes"));
	...
	TArray<class UARTrackedImage*> UARBlueprintLibrary::STATIC_GetAllTrackedImages()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllTrackedImages"));
	...
	TArray<class UAREnvironmentCaptureProbe*> UARBlueprintLibrary::STATIC_GetAllTrackedEnvironmentCaptureProbes()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllTrackedEnvironmentCaptureProbes"));
	...
	TArray<struct FARPose2D> UARBlueprintLibrary::STATIC_GetAllTracked2DPoses()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllTracked2DPoses"));
	...
	TArray<class UARPin*> UARBlueprintLibrary::STATIC_GetAllPins()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllPins"));
	...
	TArray<class UARTrackedGeometry*> UARBlueprintLibrary::STATIC_GetAllGeometriesByClass(class UClass* GeometryClass)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllGeometriesByClass"));
	...
	TArray<class UARTrackedGeometry*> UARBlueprintLibrary::STATIC_GetAllGeometries()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAllGeometries"));
	...
	struct FTransform UARBlueprintLibrary::STATIC_GetAlignmentTransform()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.GetAlignmentTransform"));
	...
	TArray<class UARTrackedPoint*> UARBlueprintLibrary::STATIC_FindTrackedPointsByName(const class FString& PointName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.FindTrackedPointsByName"));
	...
	void UARBlueprintLibrary::STATIC_DebugDrawTrackedGeometry(class UARTrackedGeometry* TrackedGeometry, class UObject* WorldContextObject, const struct FLinearColor& Color, float OutlineThickness, float PersistForSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.DebugDrawTrackedGeometry"));
	...
	void UARBlueprintLibrary::STATIC_DebugDrawPin(class UARPin* ARPin, class UObject* WorldContextObject, const struct FLinearColor& Color, float Scale, float PersistForSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.DebugDrawPin"));
	...
	void UARBlueprintLibrary::STATIC_CalculateClosestIntersection(TArray<struct FVector> StartPoints, TArray<struct FVector> Endpoints, struct FVector* ClosestIntersection)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.CalculateClosestIntersection"));
	...
	void UARBlueprintLibrary::STATIC_CalculateAlignmentTransform(const struct FTransform& TransformInFirstCoordinateSystem, const struct FTransform& TransformInSecondCoordinateSystem, struct FTransform* AlignmentTransform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.CalculateAlignmentTransform"));
	...
	bool UARBlueprintLibrary::STATIC_AddTrackedPointWithName(const struct FTransform& WorldTransform, const class FString& PointName, bool bDeletePointsWithSameName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.AddTrackedPointWithName"));
	...
	class UARCandidateImage* UARBlueprintLibrary::STATIC_AddRuntimeCandidateImage(class UARSessionConfig* SessionConfig, class UTexture2D* CandidateTexture, const class FString& FriendlyName, float PhysicalWidth)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.AddRuntimeCandidateImage"));
	...
	bool UARBlueprintLibrary::STATIC_AddManualEnvironmentCaptureProbe(const struct FVector& Location, const struct FVector& Extent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBlueprintLibrary.AddManualEnvironmentCaptureProbe"));
	...
	UClass* UARBlueprintLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARBlueprintLibrary"));
		return ptr;
	}
	...
	class UARTrackedGeometry* UARTraceResultLibrary::STATIC_GetTrackedGeometry(const struct FARTraceResult& TraceResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTraceResultLibrary.GetTrackedGeometry"));
	...
	EARLineTraceChannels UARTraceResultLibrary::STATIC_GetTraceChannel(const struct FARTraceResult& TraceResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTraceResultLibrary.GetTraceChannel"));
	...
	struct FTransform UARTraceResultLibrary::STATIC_GetLocalTransform(const struct FARTraceResult& TraceResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTraceResultLibrary.GetLocalTransform"));
	...
	struct FTransform UARTraceResultLibrary::STATIC_GetLocalToWorldTransform(const struct FARTraceResult& TraceResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTraceResultLibrary.GetLocalToWorldTransform"));
	...
	struct FTransform UARTraceResultLibrary::STATIC_GetLocalToTrackingTransform(const struct FARTraceResult& TraceResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTraceResultLibrary.GetLocalToTrackingTransform"));
	...
	float UARTraceResultLibrary::STATIC_GetDistanceFromCamera(const struct FARTraceResult& TraceResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTraceResultLibrary.GetDistanceFromCamera"));
	...
	UClass* UARTraceResultLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTraceResultLibrary"));
		return ptr;
	}
	...
	UClass* UARBaseAsyncTaskBlueprintProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARBaseAsyncTaskBlueprintProxy"));
		return ptr;
	}
	...
	class UARSaveWorldAsyncTaskBlueprintProxy* UARSaveWorldAsyncTaskBlueprintProxy::STATIC_ARSaveWorld(class UObject* WorldContextObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSaveWorldAsyncTaskBlueprintProxy.ARSaveWorld"));
	...
	UClass* UARSaveWorldAsyncTaskBlueprintProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARSaveWorldAsyncTaskBlueprintProxy"));
		return ptr;
	}
	...
	class UARGetCandidateObjectAsyncTaskBlueprintProxy* UARGetCandidateObjectAsyncTaskBlueprintProxy::STATIC_ARGetCandidateObject(class UObject* WorldContextObject, const struct FVector& Location, const struct FVector& Extent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGetCandidateObjectAsyncTaskBlueprintProxy.ARGetCandidateObject"));
	...
	UClass* UARGetCandidateObjectAsyncTaskBlueprintProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARGetCandidateObjectAsyncTaskBlueprintProxy"));
		return ptr;
	}
	...
	void UARComponent::UpdateVisualization()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARComponent.UpdateVisualization"));
	...
	void UARComponent::SetNativeID(const struct FGuid& NativeID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARComponent.SetNativeID"));
	...
	void UARComponent::ReceiveRemove()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARComponent.ReceiveRemove"));
	...
	void UARComponent::OnRep_Payload()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARComponent.OnRep_Payload"));
	...
	class UMRMeshComponent* UARComponent::GetMRMesh()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARComponent.GetMRMesh"));
	...
	UClass* UARComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARComponent"));
		return ptr;
	}
	...
	void UARPlaneComponent::STATIC_SetPlaneComponentDebugMode(EPlaneComponentDebugMode NewDebugMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneComponent.SetPlaneComponentDebugMode"));
	...
	void UARPlaneComponent::STATIC_SetObjectClassificationDebugColors(TMap<EARObjectClassification, struct FLinearColor> InColors)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneComponent.SetObjectClassificationDebugColors"));
	...
	void UARPlaneComponent::ServerUpdatePayload(const struct FARPlaneUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneComponent.ServerUpdatePayload"));
	...
	void UARPlaneComponent::ReceiveUpdate(const struct FARPlaneUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneComponent.ReceiveUpdate"));
	...
	void UARPlaneComponent::ReceiveAdd(const struct FARPlaneUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneComponent.ReceiveAdd"));
	...
	TMap<EARObjectClassification, struct FLinearColor> UARPlaneComponent::STATIC_GetObjectClassificationDebugColors()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneComponent.GetObjectClassificationDebugColors"));
	...
	UClass* UARPlaneComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARPlaneComponent"));
		return ptr;
	}
	...
	void UARPointComponent::ServerUpdatePayload(const struct FARPointUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPointComponent.ServerUpdatePayload"));
	...
	void UARPointComponent::ReceiveUpdate(const struct FARPointUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPointComponent.ReceiveUpdate"));
	...
	void UARPointComponent::ReceiveAdd(const struct FARPointUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPointComponent.ReceiveAdd"));
	...
	UClass* UARPointComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARPointComponent"));
		return ptr;
	}
	...
	void UARFaceComponent::STATIC_SetFaceComponentDebugMode(EFaceComponentDebugMode NewDebugMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceComponent.SetFaceComponentDebugMode"));
	...
	void UARFaceComponent::ServerUpdatePayload(const struct FARFaceUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceComponent.ServerUpdatePayload"));
	...
	void UARFaceComponent::ReceiveUpdate(const struct FARFaceUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceComponent.ReceiveUpdate"));
	...
	void UARFaceComponent::ReceiveAdd(const struct FARFaceUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceComponent.ReceiveAdd"));
	...
	UClass* UARFaceComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARFaceComponent"));
		return ptr;
	}
	...
	void UARImageComponent::STATIC_SetImageComponentDebugMode(EImageComponentDebugMode NewDebugMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARImageComponent.SetImageComponentDebugMode"));
	...
	void UARImageComponent::ServerUpdatePayload(const struct FARImageUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARImageComponent.ServerUpdatePayload"));
	...
	void UARImageComponent::ReceiveUpdate(const struct FARImageUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARImageComponent.ReceiveUpdate"));
	...
	void UARImageComponent::ReceiveAdd(const struct FARImageUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARImageComponent.ReceiveAdd"));
	...
	UClass* UARImageComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARImageComponent"));
		return ptr;
	}
	...
	void UARQRCodeComponent::STATIC_SetQRCodeComponentDebugMode(EQRCodeComponentDebugMode NewDebugMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARQRCodeComponent.SetQRCodeComponentDebugMode"));
	...
	void UARQRCodeComponent::ServerUpdatePayload(const struct FARQRCodeUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARQRCodeComponent.ServerUpdatePayload"));
	...
	void UARQRCodeComponent::ReceiveUpdate(const struct FARQRCodeUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARQRCodeComponent.ReceiveUpdate"));
	...
	void UARQRCodeComponent::ReceiveAdd(const struct FARQRCodeUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARQRCodeComponent.ReceiveAdd"));
	...
	UClass* UARQRCodeComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARQRCodeComponent"));
		return ptr;
	}
	...
	void UARPoseComponent::STATIC_SetPoseComponentDebugMode(EPoseComponentDebugMode NewDebugMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPoseComponent.SetPoseComponentDebugMode"));
	...
	void UARPoseComponent::ServerUpdatePayload(const struct FARPoseUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPoseComponent.ServerUpdatePayload"));
	...
	void UARPoseComponent::ReceiveUpdate(const struct FARPoseUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPoseComponent.ReceiveUpdate"));
	...
	void UARPoseComponent::ReceiveAdd(const struct FARPoseUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPoseComponent.ReceiveAdd"));
	...
	UClass* UARPoseComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARPoseComponent"));
		return ptr;
	}
	...
	void UAREnvironmentProbeComponent::ServerUpdatePayload(const struct FAREnvironmentProbeUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.AREnvironmentProbeComponent.ServerUpdatePayload"));
	...
	void UAREnvironmentProbeComponent::ReceiveUpdate(const struct FAREnvironmentProbeUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.AREnvironmentProbeComponent.ReceiveUpdate"));
	...
	void UAREnvironmentProbeComponent::ReceiveAdd(const struct FAREnvironmentProbeUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.AREnvironmentProbeComponent.ReceiveAdd"));
	...
	UClass* UAREnvironmentProbeComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.AREnvironmentProbeComponent"));
		return ptr;
	}
	...
	void UARObjectComponent::ServerUpdatePayload(const struct FARObjectUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARObjectComponent.ServerUpdatePayload"));
	...
	void UARObjectComponent::ReceiveUpdate(const struct FARObjectUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARObjectComponent.ReceiveUpdate"));
	...
	void UARObjectComponent::ReceiveAdd(const struct FARObjectUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARObjectComponent.ReceiveAdd"));
	...
	UClass* UARObjectComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARObjectComponent"));
		return ptr;
	}
	...
	void UARMeshComponent::ServerUpdatePayload(const struct FARMeshUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARMeshComponent.ServerUpdatePayload"));
	...
	void UARMeshComponent::ReceiveUpdate(const struct FARMeshUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARMeshComponent.ReceiveUpdate"));
	...
	void UARMeshComponent::ReceiveAdd(const struct FARMeshUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARMeshComponent.ReceiveAdd"));
	...
	UClass* UARMeshComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARMeshComponent"));
		return ptr;
	}
	...
	void UARGeoAnchorComponent::STATIC_SetGeoAnchorComponentDebugMode(EGeoAnchorComponentDebugMode NewDebugMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchorComponent.SetGeoAnchorComponentDebugMode"));
	...
	void UARGeoAnchorComponent::ServerUpdatePayload(const struct FARGeoAnchorUpdatePayload& NewPayload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchorComponent.ServerUpdatePayload"));
	...
	void UARGeoAnchorComponent::ReceiveUpdate(const struct FARGeoAnchorUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchorComponent.ReceiveUpdate"));
	...
	void UARGeoAnchorComponent::ReceiveAdd(const struct FARGeoAnchorUpdatePayload& Payload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchorComponent.ReceiveAdd"));
	...
	UClass* UARGeoAnchorComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARGeoAnchorComponent"));
		return ptr;
	}
	...
	void UARDependencyHandler::StartARSessionLatent(class UObject* WorldContextObject, class UARSessionConfig* SessionConfig, const struct FLatentActionInfo& LatentInfo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARDependencyHandler.StartARSessionLatent"));
	...
	void UARDependencyHandler::RequestARSessionPermission(class UObject* WorldContextObject, class UARSessionConfig* SessionConfig, const struct FLatentActionInfo& LatentInfo, EARServicePermissionRequestResult* OutPermissionResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARDependencyHandler.RequestARSessionPermission"));
	...
	void UARDependencyHandler::InstallARService(class UObject* WorldContextObject, const struct FLatentActionInfo& LatentInfo, EARServiceInstallRequestResult* OutInstallResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARDependencyHandler.InstallARService"));
	...
	class UARDependencyHandler* UARDependencyHandler::STATIC_GetARDependencyHandler()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARDependencyHandler.GetARDependencyHandler"));
	...
	void UARDependencyHandler::CheckARServiceAvailability(class UObject* WorldContextObject, const struct FLatentActionInfo& LatentInfo, EARServiceAvailability* OutAvailability)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARDependencyHandler.CheckARServiceAvailability"));
	...
	UClass* UARDependencyHandler::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARDependencyHandler"));
		return ptr;
	}
	...
	class UARGeoTrackingSupport* UARGeoTrackingSupport::STATIC_GetGeoTrackingSupport()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoTrackingSupport.GetGeoTrackingSupport"));
	...
	EARGeoTrackingStateReason UARGeoTrackingSupport::GetGeoTrackingStateReason()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoTrackingSupport.GetGeoTrackingStateReason"));
	...
	EARGeoTrackingState UARGeoTrackingSupport::GetGeoTrackingState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoTrackingSupport.GetGeoTrackingState"));
	...
	EARGeoTrackingAccuracy UARGeoTrackingSupport::GetGeoTrackingAccuracy()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoTrackingSupport.GetGeoTrackingAccuracy"));
	...
	bool UARGeoTrackingSupport::AddGeoAnchorAtLocationWithAltitude(float Longitude, float Latitude, float AltitudeMeters, const class FString& OptionalAnchorName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoTrackingSupport.AddGeoAnchorAtLocationWithAltitude"));
	...
	bool UARGeoTrackingSupport::AddGeoAnchorAtLocation(float Longitude, float Latitude, const class FString& OptionalAnchorName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoTrackingSupport.AddGeoAnchorAtLocation"));
	...
	UClass* UARGeoTrackingSupport::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARGeoTrackingSupport"));
		return ptr;
	}
	...
	void UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy::GeoTrackingAvailabilityDelegate__DelegateSignature(bool bIsAvailable, const class FString& Error)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("DelegateFunction AugmentedReality.CheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy.GeoTrackingAvailabilityDelegate__DelegateSignature"));
	...
	class UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy* UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy::STATIC_CheckGeoTrackingAvailabilityAtLocation(class UObject* WorldContextObject, float Longitude, float Latitude)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.CheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy.CheckGeoTrackingAvailabilityAtLocation"));
	...
	class UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy* UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy::STATIC_CheckGeoTrackingAvailability(class UObject* WorldContextObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.CheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy.CheckGeoTrackingAvailability"));
	...
	UClass* UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.CheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy"));
		return ptr;
	}
	...
	void UGetGeoLocationAsyncTaskBlueprintProxy::GetGeoLocationDelegate__DelegateSignature(float Longitude, float Latitude, float Altitude, const class FString& Error)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("DelegateFunction AugmentedReality.GetGeoLocationAsyncTaskBlueprintProxy.GetGeoLocationDelegate__DelegateSignature"));
	...
	class UGetGeoLocationAsyncTaskBlueprintProxy* UGetGeoLocationAsyncTaskBlueprintProxy::STATIC_GetGeoLocationAtWorldPosition(class UObject* WorldContextObject, const struct FVector& WorldPosition)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.GetGeoLocationAsyncTaskBlueprintProxy.GetGeoLocationAtWorldPosition"));
	...
	UClass* UGetGeoLocationAsyncTaskBlueprintProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.GetGeoLocationAsyncTaskBlueprintProxy"));
		return ptr;
	}
	...
	void UARLifeCycleComponent::ServerSpawnARActor(class UClass* ComponentClass, const struct FGuid& NativeID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARLifeCycleComponent.ServerSpawnARActor"));
	...
	void UARLifeCycleComponent::ServerDestroyARActor(class AARActor* Actor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARLifeCycleComponent.ServerDestroyARActor"));
	...
	void UARLifeCycleComponent::InstanceARActorToBeDestroyedDelegate__DelegateSignature(class AARActor* Actor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("DelegateFunction AugmentedReality.ARLifeCycleComponent.InstanceARActorToBeDestroyedDelegate__DelegateSignature"));
	...
	void UARLifeCycleComponent::InstanceARActorSpawnedDelegate__DelegateSignature(class UClass* ComponentClass, const struct FGuid& NativeID, class AARActor* SpawnedActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("DelegateFunction AugmentedReality.ARLifeCycleComponent.InstanceARActorSpawnedDelegate__DelegateSignature"));
	...
	UClass* UARLifeCycleComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARLifeCycleComponent"));
		return ptr;
	}
	...
	UClass* UARLightEstimate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARLightEstimate"));
		return ptr;
	}
	...
	float UARBasicLightEstimate::GetAmbientIntensityLumens()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBasicLightEstimate.GetAmbientIntensityLumens"));
	...
	float UARBasicLightEstimate::GetAmbientColorTemperatureKelvin()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBasicLightEstimate.GetAmbientColorTemperatureKelvin"));
	...
	struct FLinearColor UARBasicLightEstimate::GetAmbientColor()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARBasicLightEstimate.GetAmbientColor"));
	...
	UClass* UARBasicLightEstimate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARBasicLightEstimate"));
		return ptr;
	}
	...
	UClass* AAROriginActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.AROriginActor"));
		return ptr;
	}
	...
	EARTrackingState UARPin::GetTrackingState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.GetTrackingState"));
	...
	class UARTrackedGeometry* UARPin::GetTrackedGeometry()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.GetTrackedGeometry"));
	...
	class USceneComponent* UARPin::GetPinnedComponent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.GetPinnedComponent"));
	...
	struct FTransform UARPin::GetLocalToWorldTransform()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.GetLocalToWorldTransform"));
	...
	struct FTransform UARPin::GetLocalToTrackingTransform()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.GetLocalToTrackingTransform"));
	...
	class FName UARPin::GetDebugName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.GetDebugName"));
	...
	void UARPin::DebugDraw(class UWorld* World, const struct FLinearColor& Color, float Scale, float PersistForSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPin.DebugDraw"));
	...
	UClass* UARPin::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARPin"));
		return ptr;
	}
	...
	bool UARSessionConfig::ShouldResetTrackedObjects()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.ShouldResetTrackedObjects"));
	...
	bool UARSessionConfig::ShouldResetCameraTracking()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.ShouldResetCameraTracking"));
	...
	bool UARSessionConfig::ShouldRenderCameraOverlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.ShouldRenderCameraOverlay"));
	...
	bool UARSessionConfig::ShouldEnableCameraTracking()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.ShouldEnableCameraTracking"));
	...
	bool UARSessionConfig::ShouldEnableAutoFocus()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.ShouldEnableAutoFocus"));
	...
	void UARSessionConfig::SetWorldMapData(TArray<unsigned char> WorldMapData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetWorldMapData"));
	...
	void UARSessionConfig::SetSessionTrackingFeatureToEnable(EARSessionTrackingFeature InSessionTrackingFeature)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetSessionTrackingFeatureToEnable"));
	...
	void UARSessionConfig::SetSceneReconstructionMethod(EARSceneReconstruction InSceneReconstructionMethod)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetSceneReconstructionMethod"));
	...
	void UARSessionConfig::SetResetTrackedObjects(bool bNewValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetResetTrackedObjects"));
	...
	void UARSessionConfig::SetResetCameraTracking(bool bNewValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetResetCameraTracking"));
	...
	void UARSessionConfig::SetFaceTrackingUpdate(EARFaceTrackingUpdate InUpdate)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetFaceTrackingUpdate"));
	...
	void UARSessionConfig::SetFaceTrackingDirection(EARFaceTrackingDirection InDirection)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetFaceTrackingDirection"));
	...
	void UARSessionConfig::SetEnableAutoFocus(bool bNewValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetEnableAutoFocus"));
	...
	void UARSessionConfig::SetDesiredVideoFormat(const struct FARVideoFormat& NewFormat)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetDesiredVideoFormat"));
	...
	void UARSessionConfig::SetCandidateObjectList(TArray<class UARCandidateObject*> InCandidateObjects)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.SetCandidateObjectList"));
	...
	TArray<unsigned char> UARSessionConfig::GetWorldMapData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetWorldMapData"));
	...
	EARWorldAlignment UARSessionConfig::GetWorldAlignment()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetWorldAlignment"));
	...
	EARSessionType UARSessionConfig::GetSessionType()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetSessionType"));
	...
	EARSceneReconstruction UARSessionConfig::GetSceneReconstructionMethod()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetSceneReconstructionMethod"));
	...
	EARPlaneDetectionMode UARSessionConfig::GetPlaneDetectionMode()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetPlaneDetectionMode"));
	...
	int32_t UARSessionConfig::GetMaxNumSimultaneousImagesTracked()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetMaxNumSimultaneousImagesTracked"));
	...
	EARLightEstimationMode UARSessionConfig::GetLightEstimationMode()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetLightEstimationMode"));
	...
	EARFrameSyncMode UARSessionConfig::GetFrameSyncMode()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetFrameSyncMode"));
	...
	EARFaceTrackingUpdate UARSessionConfig::GetFaceTrackingUpdate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetFaceTrackingUpdate"));
	...
	EARFaceTrackingDirection UARSessionConfig::GetFaceTrackingDirection()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetFaceTrackingDirection"));
	...
	EAREnvironmentCaptureProbeType UARSessionConfig::GetEnvironmentCaptureProbeType()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetEnvironmentCaptureProbeType"));
	...
	EARSessionTrackingFeature UARSessionConfig::GetEnabledSessionTrackingFeature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetEnabledSessionTrackingFeature"));
	...
	struct FARVideoFormat UARSessionConfig::GetDesiredVideoFormat()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetDesiredVideoFormat"));
	...
	TArray<class UARCandidateObject*> UARSessionConfig::GetCandidateObjectList()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetCandidateObjectList"));
	...
	TArray<class UARCandidateImage*> UARSessionConfig::GetCandidateImageList()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.GetCandidateImageList"));
	...
	void UARSessionConfig::AddCandidateObject(class UARCandidateObject* CandidateObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.AddCandidateObject"));
	...
	void UARSessionConfig::AddCandidateImage(class UARCandidateImage* NewCandidateImage)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSessionConfig.AddCandidateImage"));
	...
	UClass* UARSessionConfig::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARSessionConfig"));
		return ptr;
	}
	...
	void AARSharedWorldGameMode::SetPreviewImageData(TArray<unsigned char> ImageData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldGameMode.SetPreviewImageData"));
	...
	void AARSharedWorldGameMode::SetARWorldSharingIsReady()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldGameMode.SetARWorldSharingIsReady"));
	...
	void AARSharedWorldGameMode::SetARSharedWorldData(TArray<unsigned char> ARWorldData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldGameMode.SetARSharedWorldData"));
	...
	class AARSharedWorldGameState* AARSharedWorldGameMode::GetARSharedWorldGameState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldGameMode.GetARSharedWorldGameState"));
	...
	UClass* AARSharedWorldGameMode::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARSharedWorldGameMode"));
		return ptr;
	}
	...
	void AARSharedWorldGameState::K2_OnARWorldMapIsReady()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldGameState.K2_OnARWorldMapIsReady"));
	...
	UClass* AARSharedWorldGameState::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARSharedWorldGameState"));
		return ptr;
	}
	...
	void AARSharedWorldPlayerController::ServerMarkReadyForReceiving()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldPlayerController.ServerMarkReadyForReceiving"));
	...
	void AARSharedWorldPlayerController::ClientUpdatePreviewImageData(int32_t Offset, TArray<unsigned char> Buffer)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldPlayerController.ClientUpdatePreviewImageData"));
	...
	void AARSharedWorldPlayerController::ClientUpdateARWorldData(int32_t Offset, TArray<unsigned char> Buffer)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldPlayerController.ClientUpdateARWorldData"));
	...
	void AARSharedWorldPlayerController::ClientInitSharedWorld(int32_t PreviewImageSize, int32_t ARWorldDataSize)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSharedWorldPlayerController.ClientInitSharedWorld"));
	...
	UClass* AARSharedWorldPlayerController::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARSharedWorldPlayerController"));
		return ptr;
	}
	...
	void AARSkyLight::SetEnvironmentCaptureProbe(class UAREnvironmentCaptureProbe* InCaptureProbe)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARSkyLight.SetEnvironmentCaptureProbe"));
	...
	UClass* AARSkyLight::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARSkyLight"));
		return ptr;
	}
	...
	UClass* UARTexture::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTexture"));
		return ptr;
	}
	...
	UClass* UARTextureCameraImage::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTextureCameraImage"));
		return ptr;
	}
	...
	UClass* UARTextureCameraDepth::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTextureCameraDepth"));
		return ptr;
	}
	...
	UClass* UAREnvironmentCaptureProbeTexture::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.AREnvironmentCaptureProbeTexture"));
		return ptr;
	}
	...
	UClass* UARTraceResultDummy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTraceResultDummy"));
		return ptr;
	}
	...
	bool UARTrackedGeometry::IsTracked()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.IsTracked"));
	...
	bool UARTrackedGeometry::HasSpatialMeshUsageFlag(EARSpatialMeshUsageFlags InFlag)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.HasSpatialMeshUsageFlag"));
	...
	class UMRMeshComponent* UARTrackedGeometry::GetUnderlyingMesh()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetUnderlyingMesh"));
	...
	EARTrackingState UARTrackedGeometry::GetTrackingState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetTrackingState"));
	...
	EARObjectClassification UARTrackedGeometry::GetObjectClassification()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetObjectClassification"));
	...
	class FString UARTrackedGeometry::GetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetName"));
	...
	struct FTransform UARTrackedGeometry::GetLocalToWorldTransform()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetLocalToWorldTransform"));
	...
	struct FTransform UARTrackedGeometry::GetLocalToTrackingTransform()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetLocalToTrackingTransform"));
	...
	float UARTrackedGeometry::GetLastUpdateTimestamp()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetLastUpdateTimestamp"));
	...
	int32_t UARTrackedGeometry::GetLastUpdateFrameNumber()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetLastUpdateFrameNumber"));
	...
	class FName UARTrackedGeometry::GetDebugName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedGeometry.GetDebugName"));
	...
	UClass* UARTrackedGeometry::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackedGeometry"));
		return ptr;
	}
	...
	class UARPlaneGeometry* UARPlaneGeometry::GetSubsumedBy()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneGeometry.GetSubsumedBy"));
	...
	EARPlaneOrientation UARPlaneGeometry::GetOrientation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneGeometry.GetOrientation"));
	...
	struct FVector UARPlaneGeometry::GetExtent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneGeometry.GetExtent"));
	...
	struct FVector UARPlaneGeometry::GetCenter()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneGeometry.GetCenter"));
	...
	TArray<struct FVector> UARPlaneGeometry::GetBoundaryPolygonInLocalSpace()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARPlaneGeometry.GetBoundaryPolygonInLocalSpace"));
	...
	UClass* UARPlaneGeometry::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARPlaneGeometry"));
		return ptr;
	}
	...
	UClass* UARTrackedPoint::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackedPoint"));
		return ptr;
	}
	...
	struct FVector2D UARTrackedImage::GetEstimateSize()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedImage.GetEstimateSize"));
	...
	class UARCandidateImage* UARTrackedImage::GetDetectedImage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedImage.GetDetectedImage"));
	...
	UClass* UARTrackedImage::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackedImage"));
		return ptr;
	}
	...
	UClass* UARTrackedQRCode::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackedQRCode"));
		return ptr;
	}
	...
	struct FTransform UARFaceGeometry::GetWorldSpaceEyeTransform(EAREye Eye)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceGeometry.GetWorldSpaceEyeTransform"));
	...
	struct FTransform UARFaceGeometry::GetLocalSpaceEyeTransform(EAREye Eye)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceGeometry.GetLocalSpaceEyeTransform"));
	...
	float UARFaceGeometry::GetBlendShapeValue(EARFaceBlendShape BlendShape)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceGeometry.GetBlendShapeValue"));
	...
	TMap<EARFaceBlendShape, float> UARFaceGeometry::GetBlendShapes()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARFaceGeometry.GetBlendShapes"));
	...
	UClass* UARFaceGeometry::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARFaceGeometry"));
		return ptr;
	}
	...
	struct FVector UAREnvironmentCaptureProbe::GetExtent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.AREnvironmentCaptureProbe.GetExtent"));
	...
	class UAREnvironmentCaptureProbeTexture* UAREnvironmentCaptureProbe::GetEnvironmentCaptureTexture()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.AREnvironmentCaptureProbe.GetEnvironmentCaptureTexture"));
	...
	UClass* UAREnvironmentCaptureProbe::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.AREnvironmentCaptureProbe"));
		return ptr;
	}
	...
	class UARCandidateObject* UARTrackedObject::GetDetectedObject()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedObject.GetDetectedObject"));
	...
	UClass* UARTrackedObject::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackedObject"));
		return ptr;
	}
	...
	struct FARPose3D UARTrackedPose::GetTrackedPoseData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARTrackedPose.GetTrackedPoseData"));
	...
	UClass* UARTrackedPose::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackedPose"));
		return ptr;
	}
	...
	bool UARMeshGeometry::GetObjectClassificationAtLocation(const struct FVector& InWorldLocation, EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARMeshGeometry.GetObjectClassificationAtLocation"));
	...
	UClass* UARMeshGeometry::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARMeshGeometry"));
		return ptr;
	}
	...
	float UARGeoAnchor::GetLongitude()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchor.GetLongitude"));
	...
	float UARGeoAnchor::GetLatitude()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchor.GetLatitude"));
	...
	EARAltitudeSource UARGeoAnchor::GetAltitudeSource()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchor.GetAltitudeSource"));
	...
	float UARGeoAnchor::GetAltitudeMeters()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARGeoAnchor.GetAltitudeMeters"));
	...
	UClass* UARGeoAnchor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARGeoAnchor"));
		return ptr;
	}
	...
	UClass* UARTrackableNotifyComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTrackableNotifyComponent"));
		return ptr;
	}
	...
	UClass* UARTypesDummyClass::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARTypesDummyClass"));
		return ptr;
	}
	...
	float UARCandidateImage::GetPhysicalWidth()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateImage.GetPhysicalWidth"));
	...
	float UARCandidateImage::GetPhysicalHeight()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateImage.GetPhysicalHeight"));
	...
	EARCandidateImageOrientation UARCandidateImage::GetOrientation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateImage.GetOrientation"));
	...
	class FString UARCandidateImage::GetFriendlyName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateImage.GetFriendlyName"));
	...
	class UTexture2D* UARCandidateImage::GetCandidateTexture()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateImage.GetCandidateTexture"));
	...
	UClass* UARCandidateImage::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARCandidateImage"));
		return ptr;
	}
	...
	void UARCandidateObject::SetFriendlyName(const class FString& NewName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateObject.SetFriendlyName"));
	...
	void UARCandidateObject::SetCandidateObjectData(TArray<unsigned char> InCandidateObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateObject.SetCandidateObjectData"));
	...
	void UARCandidateObject::SetBoundingBox(const struct FBox& InBoundingBox)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateObject.SetBoundingBox"));
	...
	class FString UARCandidateObject::GetFriendlyName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateObject.GetFriendlyName"));
	...
	TArray<unsigned char> UARCandidateObject::GetCandidateObjectData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateObject.GetCandidateObjectData"));
	...
	struct FBox UARCandidateObject::GetBoundingBox()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function AugmentedReality.ARCandidateObject.GetBoundingBox"));
	...
	UClass* UARCandidateObject::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class AugmentedReality.ARCandidateObject"));
		return ptr;
	}
