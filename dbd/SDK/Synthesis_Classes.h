...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G8NO[0x6BC];                                 // 0x06E4(0x06BC) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NTEG[0x58];                                  // 0x0070(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_QQT5[0xA0];                                  // 0x0070(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_J6A6[0x50];                                  // 0x0070(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_XD7H[0x10];                                  // 0x00C8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8DXY[0x34];                                  // 0x0070(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_8BEB[0x38];                                  // 0x0070(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_CI97[0x48];                                  // 0x0070(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_X2PP[0x34];                                  // 0x0070(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_OHHR[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_U1AA[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_2OS0[0x38];                                  // 0x0070(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_JJXK[0x48];                                  // 0x0070(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_7JQX[0x40];                                  // 0x0070(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_XLSR[0x4C];                                  // 0x0070(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_FFS3[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_OAZN[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_QVOG[0x56];                                  // 0x00A2(0x0056) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_AR6C[0x34];                                  // 0x0070(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W050[0x4];                                   // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7VD5[0x34];                                  // 0x0070(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_B4UF[0x38];                                  // 0x0070(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_8FD7[0x48];                                  // 0x0070(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_CSCU[0x4C];                                  // 0x0070(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_DL84[0x40];                                  // 0x0070(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSubmixEffectTapDelaySettings                       Settings;                                                // 0x00B0(0x0018) Edit, BlueprintVisible, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_NOUV[0x18];                                  // 0x00C8(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_517J[0x4];                                   // 0x0148(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_QS05[0x4];                                   // 0x015C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_R2CX[0x2];                                   // 0x0452(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N5ZK[0x7];                                   // 0x0459(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4V81[0x10];                                  // 0x04C0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_234G[0x3B8];                                 // 0x06E8(0x03B8) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                       bLockKeyframesToGridBool : 1;                            // 0x0040(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_AKDE[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_94TM[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       bNormalizeWaveTables : 1;                                // 0x0060(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_003S[0x117];                                 // 0x0061(0x0117) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FKMZ[0x718];                                 // 0x0708(0x0718) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_U559[0x18];                                  // 0x06E8(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BDTK[0x108];                                 // 0x0708(0x0108) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                       ShowTooltipInfo : 1;                                     // 0x0140(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_6G4U[0x7];                                   // 0x0141(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OUZE[0x4];                                   // 0x0188(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		unsigned char                                              UnknownData_K6GY[0x4];                                   // 0x018C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OOKP[0x6];                                   // 0x03EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N75E[0x10];                                  // 0x0440(0x0010) MISSED OFFSET (PADDING)
