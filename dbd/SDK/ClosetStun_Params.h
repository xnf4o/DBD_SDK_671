...
namespace CG
{
	 ...
	 */
	struct UClosetStun_C_GetCamper_Params
	{
	public:
	 ...
	 */
	struct UClosetStun_C_OnInteractionEnterStart_Params
	{
	public:
	 ...
	 */
	struct UClosetStun_C_ExecuteUbergraph_ClosetStun_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_340Z[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
