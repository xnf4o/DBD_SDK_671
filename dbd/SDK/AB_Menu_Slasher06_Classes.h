...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_WDQU[0x8];                                   // 0x02F8(0x0008) Fix Super Size
		...
		struct FAnimNode_RandomPlayer                              AnimGraphNode_RandomPlayer;                              // 0x03C0(0x0078)
	...
	public:
		...
		void ExecuteUbergraph_AB_Menu_Slasher06(int32_t EntryPoint);
