...
namespace CG
{
	...
	public:
		...
		unsigned char                                              pad_ZBV90N0P0E[0x04];                                    // 0x0014(0x0004)
	...
	{
	public:
		uint32_t                                                   ComparisonId;                                            // 0x0000(0x0000) FNameEntryId
	...
	public:
		static const constexpr int32_t                             Stride = 0x04;                                           // 0x0000(0x0000)
	...
	public:
		...
		uint32_t                                                   DisplayIndex;                                            // 0x0000(0x0000)
