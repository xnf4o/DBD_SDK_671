...
namespace CG
{
	...
	void ABP_Sky_Sphere_C::RefreshMaterial()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Sky_Sphere.BP_Sky_Sphere_C.RefreshMaterial"));
	...
	void ABP_Sky_Sphere_C::UpdateSunDirection()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Sky_Sphere.BP_Sky_Sphere_C.UpdateSunDirection"));
	...
	void ABP_Sky_Sphere_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Sky_Sphere.BP_Sky_Sphere_C.UserConstructionScript"));
	...
	UClass* ABP_Sky_Sphere_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Sky_Sphere.BP_Sky_Sphere_C"));
		return ptr;
	}
