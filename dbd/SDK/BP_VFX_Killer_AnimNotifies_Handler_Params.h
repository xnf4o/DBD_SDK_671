...
namespace CG
{
	 ...
	 */
	struct UBP_VFX_Killer_AnimNotifies_Handler_C_HandleAnimNotify_Params
	{
	public:
		...
		unsigned char                                              UnknownData_FVW4[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
