...
namespace CG
{
	...
	UClass* UPropertyAccess::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PropertyAccess.PropertyAccess"));
		return ptr;
	}
	...
	UClass* UPropertyEventBroadcaster::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PropertyAccess.PropertyEventBroadcaster"));
		return ptr;
	}
	...
	UClass* UPropertyEventSubscriber::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class PropertyAccess.PropertyEventSubscriber"));
		return ptr;
	}
