...
namespace CG
{
	...
	UClass* UChatroom::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.Chatroom"));
		return ptr;
	}
	...
	UClass* USocialManager::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialManager"));
		return ptr;
	}
	...
	UClass* USocialParty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialParty"));
		return ptr;
	}
	...
	UClass* UPartyMember::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.PartyMember"));
		return ptr;
	}
	...
	UClass* USocialToolkit::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialToolkit"));
		return ptr;
	}
	...
	UClass* USocialChatManager::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialChatManager"));
		return ptr;
	}
	...
	UClass* USocialChatChannel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialChatChannel"));
		return ptr;
	}
	...
	UClass* USocialChatRoom::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialChatRoom"));
		return ptr;
	}
	...
	UClass* USocialDebugTools::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialDebugTools"));
		return ptr;
	}
	...
	UClass* USocialGroupChannel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialGroupChannel"));
		return ptr;
	}
	...
	UClass* USocialPartyChatRoom::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialPartyChatRoom"));
		return ptr;
	}
	...
	UClass* USocialPrivateMessageChannel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialPrivateMessageChannel"));
		return ptr;
	}
	...
	UClass* USocialReadOnlyChatChannel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialReadOnlyChatChannel"));
		return ptr;
	}
	...
	UClass* USocialSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialSettings"));
		return ptr;
	}
	...
	UClass* USocialUser::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class Party.SocialUser"));
		return ptr;
	}
