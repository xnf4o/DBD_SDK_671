...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_04OZ[0x4];                                   // 0x00AC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_HQQ5[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OT2L[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FJPB[0x4];                                   // 0x00AC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_4789[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PE9N[0x3];                                   // 0x0131(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_02G2[0x40];                                  // 0x0140(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GJCQ[0x28];                                  // 0x0188(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XXDI[0x38];                                  // 0x0088(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9FCT[0x3C];                                  // 0x00A4(0x003C) MISSED OFFSET (PADDING)
