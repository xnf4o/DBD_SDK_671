...
namespace CG
{
	...
	UClass* UMovieSceneGeometryCacheSection::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GeometryCacheTracks.MovieSceneGeometryCacheSection"));
		return ptr;
	}
	...
	UClass* UMovieSceneGeometryCacheTrack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class GeometryCacheTracks.MovieSceneGeometryCacheTrack"));
		return ptr;
	}
