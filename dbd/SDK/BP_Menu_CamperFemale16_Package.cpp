...
namespace CG
{
	...
	void ABP_Menu_CamperFemale16_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Menu_CamperFemale16.BP_Menu_CamperFemale16_C.ReceiveBeginPlay"));
	...
	void ABP_Menu_CamperFemale16_C::ExecuteUbergraph_BP_Menu_CamperFemale16(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Menu_CamperFemale16.BP_Menu_CamperFemale16_C.ExecuteUbergraph_BP_Menu_CamperFemale16"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_Menu_CamperFemale16_C.StaticClass
	...
	UClass* ABP_Menu_CamperFemale16_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Menu_CamperFemale16.BP_Menu_CamperFemale16_C"));
		return ptr;
	}
