...
namespace CG
{
	...
	void UBP_Audio_KLR_19_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_20.BP_Audio_KLR_19_C.ReceiveBeginPlay"));
	...
	void UBP_Audio_KLR_19_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_20.BP_Audio_KLR_19_C.ReceiveEndPlay"));
	...
	void UBP_Audio_KLR_19_C::ExecuteUbergraph_BP_Audio_KLR_20(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_20.BP_Audio_KLR_19_C.ExecuteUbergraph_BP_Audio_KLR_20"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_Audio_KLR_19_C.StaticClass
	...
	UClass* UBP_Audio_KLR_19_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Audio_KLR_20.BP_Audio_KLR_19_C"));
		return ptr;
	}
