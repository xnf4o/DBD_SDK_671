...
namespace CG
{
	...
	void UBP_Audio_KLR_27_C::OnKillerSoundbankLoaded(EAkResult Result)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_28.BP_Audio_KLR_27_C.OnKillerSoundbankLoaded"));
	...
	void UBP_Audio_KLR_27_C::IsCharacter(class ADBDPlayer* CamperPlayer, TArray<class FString>* characterName, bool* IsCharacter)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_28.BP_Audio_KLR_27_C.IsCharacter"));
	...
	void UBP_Audio_KLR_27_C::SelectAudioStatusStartEvent(bool IsInMenu, class UAkAudioEvent** AudioEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_28.BP_Audio_KLR_27_C.SelectAudioStatusStartEvent"));
	...
	void UBP_Audio_KLR_27_C::HitImpactOnSurvivorSFX(class ACamperPlayer* camper, EAttackType attackType, bool IsWeaponHit)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_28.BP_Audio_KLR_27_C.HitImpactOnSurvivorSFX"));
	...
	void UBP_Audio_KLR_27_C::ExecuteUbergraph_BP_Audio_KLR_28(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Audio_KLR_28.BP_Audio_KLR_27_C.ExecuteUbergraph_BP_Audio_KLR_28"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_Audio_KLR_27_C.StaticClass
	...
	UClass* UBP_Audio_KLR_27_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Audio_KLR_28.BP_Audio_KLR_27_C"));
		return ptr;
	}
