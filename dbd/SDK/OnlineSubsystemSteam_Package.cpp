...
namespace CG
{
	...
	UClass* USteamAuthComponentModuleInterface::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("Class OnlineSubsystemSteam.SteamAuthComponentModuleInterface"));
		return ptr;
	}
	...
	UClass* USteamNetConnection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class OnlineSubsystemSteam.SteamNetConnection"));
		return ptr;
	}
	...
	UClass* USteamNetDriver::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xor("Class OnlineSubsystemSteam.SteamNetDriver"));
		return ptr;
	}
