...
namespace CG
{
	...
	void ABP_Menu_Slasher01_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Menu_Slasher01.BP_Menu_Slasher01_C.ReceiveBeginPlay"));
	...
	void ABP_Menu_Slasher01_C::ExecuteUbergraph_BP_Menu_Slasher01(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xor("Function BP_Menu_Slasher01.BP_Menu_Slasher01_C.ExecuteUbergraph_BP_Menu_Slasher01"));
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_Menu_Slasher01_C.StaticClass
	...
	UClass* ABP_Menu_Slasher01_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xor("BlueprintGeneratedClass BP_Menu_Slasher01.BP_Menu_Slasher01_C"));
		return ptr;
	}
