...
namespace CG
{
	 ...
	 */
	struct UAB_Menu_Slasher06_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UAB_Menu_Slasher06_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UAB_Menu_Slasher06_C_ExecuteUbergraph_AB_Menu_Slasher06_Params
	{
	public:
